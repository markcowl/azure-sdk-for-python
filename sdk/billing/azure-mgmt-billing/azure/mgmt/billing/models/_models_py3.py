...
class Amount(Model):
    ...
    :param currency: The currency for the amount value.
    :type currency: str
    ...
    def __init__(self, *, currency: str=None, value: float=None, **kwargs) -> None:
...
class BillingProfile(Resource):
    ...
    :param budget_information: The budget information associated with the
     billing profile.
    :type budget_information: ~azure.mgmt.billing.models.BudgetInformation
    """
    ...
    _attribute_map = {
        ...
        'budget_information': {'key': 'properties.budgetInformation', 'type': 'BudgetInformation'},
    }

    def __init__(self, *, display_name: str=None, po_number: str=None, address=None, invoice_email_opt_in: bool=None, enabled_azure_plans=None, invoice_sections=None, budget_information=None, **kwargs) -> None:
        ...
        self.budget_information = budget_information
...
class BudgetInformation(Model):
    """Budget information.

    :param amount: The budget amount.
    :type amount: ~azure.mgmt.billing.models.Amount
    :param start_date: Start Date.
    :type start_date: datetime
    :param end_date: End Date.
    :type end_date: datetime
    :param external_reference_id: Reference Id for this budget information.
    ...
    def __init__(self, *, amount=None, start_date=None, end_date=None, external_reference_id: str=None, **kwargs) -> None:
        super(BudgetInformation, self).__init__(**kwargs)
        self.amount = amount
