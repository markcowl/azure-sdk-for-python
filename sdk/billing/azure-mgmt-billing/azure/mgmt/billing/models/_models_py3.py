...
class Policy(Resource):
    ...
    :param enable_microsoft_azure_plan: Enable Microsoft azure plan
    :type enable_microsoft_azure_plan:
     ~azure.mgmt.billing.models.PolicyPropertiesEnableMicrosoftAzurePlan
    """
    ...
    _attribute_map = {
        ...
        'view_charges': {'key': 'properties.viewCharges', 'type': 'str'},
        'enable_microsoft_azure_plan': {'key': 'properties.enableMicrosoftAzurePlan', 'type': 'PolicyPropertiesEnableMicrosoftAzurePlan'},
    }

    def __init__(self, *, marketplace_purchases=None, reservation_purchases=None, view_charges=None, enable_microsoft_azure_plan=None, **kwargs) -> None:
        super(Policy, self).__init__(**kwargs)
        self.marketplace_purchases = marketplace_purchases
        self.reservation_purchases = reservation_purchases
        self.view_charges = view_charges
        self.enable_microsoft_azure_plan = enable_microsoft_azure_plan


class PolicyPropertiesEnableMicrosoftAzurePlan(Model):
    """Enable Microsoft azure plan.

    :param enabled: Specifies whether azure plan is enabled.
    :type enabled: bool
    :param budget_amount: Budget amount for policy
    :type budget_amount: float
    :param start_date: Start date of policy
    :type start_date: datetime
    :param end_date: End date of policy
    :type end_date: datetime
    :param external_reference_id: External reference
    :type external_reference_id: str
    """

    _attribute_map = {
        'enabled': {'key': 'enabled', 'type': 'bool'},
        'budget_amount': {'key': 'budgetAmount', 'type': 'float'},
        'start_date': {'key': 'startDate', 'type': 'iso-8601'},
        'end_date': {'key': 'endDate', 'type': 'iso-8601'},
        'external_reference_id': {'key': 'externalReferenceId', 'type': 'str'},
    }

    def __init__(self, *, enabled: bool=None, budget_amount: float=None, start_date=None, end_date=None, external_reference_id: str=None, **kwargs) -> None:
        super(PolicyPropertiesEnableMicrosoftAzurePlan, self).__init__(**kwargs)
