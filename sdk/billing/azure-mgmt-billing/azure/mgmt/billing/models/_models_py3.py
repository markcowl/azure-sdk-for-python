...
class Agreement(Resource):
    ...
    :param category: Category of the agreement signed by customer. Possible
     values include: 'MicrosoftCustomerAgreement', 'AffiliatePurchaseTerms',
     'Other'
    :type category: str or ~azure.mgmt.billing.models.Category
    :param acceptance_mode: The mode of acceptance for an agreement. Possible
     values include: 'ClickToAccept', 'ESignEmbedded', 'ESignOffline'
    :type acceptance_mode: str or ~azure.mgmt.billing.models.AcceptanceMode
    ...
    def __init__(self, *, category=None, acceptance_mode=None, participants=None, **kwargs) -> None:
