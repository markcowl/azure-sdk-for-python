...
class Policy(Resource):
    ...
    def __init__(self, **kwargs):
        ...
        self.view_charges = kwargs.get('view_charges', None)
        self.enable_microsoft_azure_plan = kwargs.get('enable_microsoft_azure_plan', None)
...
class PolicyPropertiesEnableMicrosoftAzurePlan(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.budget_amount = kwargs.get('budget_amount', None)
        self.start_date = kwargs.get('start_date', None)
        self.end_date = kwargs.get('end_date', None)
        self.external_reference_id = kwargs.get('external_reference_id', None)
