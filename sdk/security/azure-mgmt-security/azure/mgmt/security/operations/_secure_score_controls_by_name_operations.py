...
class SecureScoreControlsByNameOperations(object):
    """SecureScoreControlsByNameOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/{scope}/providers/Microsoft.Security/secureScores/{secureScoreName}/secureScoreControls'}
