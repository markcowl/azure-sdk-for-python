...
class SecureScoreControlsDefinitionOperations(object):
    """SecureScoreControlsDefinitionOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/providers/Microsoft.Security/secureScoreControlsDefinition'}
