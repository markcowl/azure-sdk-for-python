...
class AssessmentsMetadataOperations(object):
    ...
    def get_metadata_in_subscription(
            self, assessment_metadata_name, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.get_metadata_in_subscription.metadata['url']
        path_format_arguments = {
            'assessmentMetadataName': self._serialize.url("assessment_metadata_name", assessment_metadata_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$')
        }
        ...
        return deserialized
    get_metadata_in_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}'}
    ...
    def create_or_update(
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/assessmentMetadata/{assessmentMetadataName}'}
