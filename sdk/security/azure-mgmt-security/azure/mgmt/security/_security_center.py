...
from .operations import SecureScoreControlsByNameOperations
from .operations import SecureScoreControlsOperations
from .operations import SecureScoreControlsDefinitionOperations
from .operations import SecureScoreControlsDefinitionSubscriptionOperations
from . import models
...
class SecurityCenter(SDKClient):
    ...
    :ivar secure_score_controls_by_name: SecureScoreControlsByName operations
    :vartype secure_score_controls_by_name: azure.mgmt.security.operations.SecureScoreControlsByNameOperations
    ...
    :ivar secure_score_controls_definition: SecureScoreControlsDefinition operations
    :vartype secure_score_controls_definition: azure.mgmt.security.operations.SecureScoreControlsDefinitionOperations
    :ivar secure_score_controls_definition_subscription: SecureScoreControlsDefinitionSubscription operations
    :vartype secure_score_controls_definition_subscription: azure.mgmt.security.operations.SecureScoreControlsDefinitionSubscriptionOperations
    ...
    def __init__(
        ...
        self.secure_scores = SecureScoresOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.secure_score_controls_by_name = SecureScoreControlsByNameOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.secure_score_controls = SecureScoreControlsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.secure_score_controls_definition = SecureScoreControlsDefinitionOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.secure_score_controls_definition_subscription = SecureScoreControlsDefinitionSubscriptionOperations(
            self._client, self.config, self._serialize, self._deserialize)
