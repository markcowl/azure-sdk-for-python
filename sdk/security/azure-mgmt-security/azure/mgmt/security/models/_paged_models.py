...
class SecureScoresItemPaged(Paged):
    """
    A paging container for iterating over a list of :class:`SecureScoresItem <azure.mgmt.security.models.SecureScoresItem>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[SecureScoresItem]'}
    }

    def __init__(self, *args, **kwargs):

        super(SecureScoresItemPaged, self).__init__(*args, **kwargs)
