...
class ApplicationGatewayRewriteRuleActionSet(Model):
    ...
    :type url_configuration:
     ~azure.mgmt.network.v2019_11_01.models.ApplicationGatewayUrlConfiguration
    """
...
class ConnectivityConfiguration(SubResource):
    ...
    :param id: Resource ID.
    :type id: str
    :ivar display_name: A friendly name for the assignment.
    :vartype display_name: str
    :param description: A description of the Connectivity Configuration.
    :type description: str
    :param connectivity_type: Required. Gets or sets the connectivity type of
     a network structure Configuration. Possible values include:
     'HubAndSpokeTopology', 'MeshTopology'
    :type connectivity_type: str or
     ~azure.mgmt.network.v2019_11_01.models.ConnectivityType
    ...
    _attribute_map = {
        ...
        'connectivity_type': {'key': 'properties.connectivityType', 'type': 'str'},
    ...
    def __init__(self, *, connectivity_type, id: str=None, description: str=None, hub_id: str=None, applies_to_groups=None, **kwargs) -> None:
        super(ConnectivityConfiguration, self).__init__(id=id, **kwargs)
...
class Deployment(Model):
    """Configuration and location lists to deploy.
    ...
    def __init__(self, *, configuration: str=None, location=None, **kwargs) -> None:
        super(Deployment, self).__init__(**kwargs)
        self.configuration = configuration
        self.location = location


class DeploymentGroupItem(Model):
    """DeploymentGroupItem.

    :param group_members: group of Network Manager rule.
    :type group_members: list[str]
    :param conditional_membership: group filter.
    :type conditional_membership: object
    :param deployed_time: deploy Time.
    :type deployed_time: datetime
    """

    _attribute_map = {
        'group_members': {'key': 'groupMembers', 'type': '[str]'},
        'conditional_membership': {'key': 'conditionalMembership', 'type': 'object'},
        'deployed_time': {'key': 'deployedTime', 'type': 'iso-8601'},
    }

    def __init__(self, *, group_members=None, conditional_membership=None, deployed_time=None, **kwargs) -> None:
        super(DeploymentGroupItem, self).__init__(**kwargs)
...
class DeploymentResult(Model):
    ...
    :param configuration: configuration Id need to deploy.
    :type configuration: str
    :param deployed_time: Deployed Time
    :type deployed_time: datetime
    """
    ...
    def __init__(self, *, configuration: str=None, deployed_time=None, **kwargs) -> None:
        super(DeploymentResult, self).__init__(**kwargs)
        self.configuration = configuration
        self.deployed_time = deployed_time


class DeploymentRule(SubResource):
    ...
    :param id: Resource ID.
    :type id: str
    :param display_name: A friendly name for the deployment rule.
    ...
    :type access: str or
     ~azure.mgmt.network.v2019_11_01.models.DeploymentRuleAccess
    ...
    :type direction: str or
     ~azure.mgmt.network.v2019_11_01.models.DeploymentRuleDirection
    ...
    :param applies_to_groups: Groups for configuration
    :type applies_to_groups:
     list[~azure.mgmt.network.v2019_11_01.models.DeploymentGroupItem]
    :ivar name: Resource name.
    :vartype name: str
    :ivar type: Resource type.
    :vartype type: str
    ...
    _attribute_map = {
        ...
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
        'applies_to_groups': {'key': 'properties.appliesToGroups', 'type': '[DeploymentGroupItem]'},
        'name': {'key': 'name', 'type': 'str'},
        'type': {'key': 'type', 'type': 'str'},
        'etag': {'key': 'etag', 'type': 'str'},
    }

    def __init__(self, *, protocol, access, priority: int, direction, id: str=None, display_name: str=None, description: str=None, source_address_prefixes=None, destination_address_prefixes=None, source_port_ranges=None, destination_port_ranges=None, applies_to_groups=None, **kwargs) -> None:
        super(DeploymentRule, self).__init__(id=id, **kwargs)
...
class NetworkGroup(SubResource):
    ...
    :type description: str
    :param group_members: Scope of Network Manager.
    :type group_members: list[str]
    :param conditional_membership: group filter.
    :type conditional_membership: object
    ...
    _attribute_map = {
        ...
        'display_name': {'key': 'properties.displayName', 'type': 'str'},
        'description': {'key': 'properties.description', 'type': 'str'},
        'group_members': {'key': 'properties.groupMembers', 'type': '[str]'},
    ...
    def __init__(self, *, id: str=None, display_name: str=None, description: str=None, group_members=None, conditional_membership=None, **kwargs) -> None:
        super(NetworkGroup, self).__init__(id=id, **kwargs)
        self.display_name = display_name
        self.description = description
        self.group_members = group_members
        self.conditional_membership = conditional_membership
...
class NetworkManager(Resource):
    ...
    :param network_manager_scope_access: Scope Access.
    :type network_manager_scope_access: list[str]
    :ivar provisioning_state: The provisioning state of the scope assignment
     resource. Possible values include: 'Succeeded', 'Updating', 'Deleting',
     'Failed'
    :vartype provisioning_state: str or
    ...
    _attribute_map = {
        ...
        'network_manager_scope_access': {'key': 'properties.networkManagerScopeAccess', 'type': '[str]'},
        'provisioning_state': {'key': 'properties.provisioningState', 'type': 'str'},
        'safe_deployment': {'key': 'properties.safeDeployment', 'type': 'bool'},
        'etag': {'key': 'etag', 'type': 'str'},
    }

    def __init__(self, *, id: str=None, location: str=None, tags=None, display_name: str=None, description: str=None, network_manager_scopes=None, network_manager_scope_access=None, safe_deployment: bool=None, **kwargs) -> None:
        ...
        self.network_manager_scope_access = network_manager_scope_access
        self.provisioning_state = None
...
class NetworkManagerGroupItem(Model):
    ...
    def __init__(self, *, network_group_id: str=None, delete_existing_peering: bool=None, group_connectivity=None, **kwargs) -> None:
...
class NetworkManagerPropertiesNetworkManagerScopes(Model):
    ...
    def __init__(self, *, management_groups=None, subscriptions=None, **kwargs) -> None:
...
class NetworkManagerSecurityGroupItem(Model):
    ...
    def __init__(self, *, network_group_id: str=None, **kwargs) -> None:
...
class SecurityConfiguration(SubResource):
    ...
    def __init__(self, *, id: str=None, display_name: str=None, description: str=None, **kwargs) -> None:
        super(SecurityConfiguration, self).__init__(id=id, **kwargs)
        self.display_name = display_name
        self.description = description
        self.provisioning_state = None
        self.name = None
...
class SecurityConfigurationRule(SubResource):
    ...
    def __init__(self, *, protocol, access, priority: int, direction, id: str=None, description: str=None, source_address_prefixes=None, destination_address_prefixes=None, source_port_ranges=None, destination_port_ranges=None, applies_to_groups=None, **kwargs) -> None:
        super(SecurityConfigurationRule, self).__init__(id=id, **kwargs)
        self.description = description
        self.protocol = protocol
        self.source_address_prefixes = source_address_prefixes
        self.destination_address_prefixes = destination_address_prefixes
