...
class DeploymentGroupItem(Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.deployed_time = kwargs.get('deployed_time', None)
...
class DeploymentRule(SubResource):
    ...
    def __init__(self, **kwargs):
        super(DeploymentRule, self).__init__(**kwargs)
...
class NetworkManager(Resource):
    ...
    def __init__(self, **kwargs):
        ...
        self.network_manager_scope_access = kwargs.get('network_manager_scope_access', None)
        self.provisioning_state = None
