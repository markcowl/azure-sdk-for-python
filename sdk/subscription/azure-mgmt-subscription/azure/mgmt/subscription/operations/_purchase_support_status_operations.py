...
class PurchaseSupportStatusOperations(object):
    """PurchaseSupportStatusOperations operations.
    ...
    def get(
        ...
        :return: An instance of LROPoller that returns
         DefaultSupportPlanResponseResult or
         ClientRawResponse<DefaultSupportPlanResponseResult> if raw==True
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.subscription.models.DefaultSupportPlanResponseResult]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.subscription.models.DefaultSupportPlanResponseResult]]
        :raises:
    ...
    get.metadata = {'url': '/providers/Microsoft.Subscription/OperationResults/{OperationId}'}
