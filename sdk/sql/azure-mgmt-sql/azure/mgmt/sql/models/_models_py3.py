...
class ManagedInstance(TrackedResource):
    ...
    :param maintenance_policy_id: Specifies maintenance policy id to apply to
     this managed instance.
    :type maintenance_policy_id: str
    """
    ...
    _attribute_map = {
        ...
        'maintenance_policy_id': {'key': 'properties.maintenancePolicyId', 'type': 'str'},
    }
    ...
    def __init__(self, *, location: str, tags=None, identity=None, sku=None, managed_instance_create_mode=None, administrator_login: str=None, administrator_login_password: str=None, subnet_id: str=None, license_type=None, v_cores: int=None, storage_size_in_gb: int=None, collation: str=None, dns_zone_partner: str=None, public_data_endpoint_enabled: bool=None, source_managed_instance_id: str=None, restore_point_in_time=None, proxy_override=None, timezone_id: str=None, instance_pool_id: str=None, maintenance_policy_id: str=None, **kwargs) -> None:
        ...
        self.maintenance_policy_id = maintenance_policy_id
...
class VirtualCluster(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, family: str=None, maintenance_policy_id: str=None, **kwargs) -> None:
...
class VirtualClusterUpdate(Model):
    ...
    def __init__(self, *, family: str=None, maintenance_policy_id: str=None, tags=None, **kwargs) -> None:
