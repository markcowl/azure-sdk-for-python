...
class LoadBalancePort(Model):
    ...
    def __init__(self, *, frontend_port: int=None, backend_port: int=None, protocol=None, **kwargs) -> None:
...
class ManagedCluster(Resource):
    ...
    def __init__(self, *, location: str, dns_name: str, vm_admin_user: str, tags=None, client_connection_port: int=19000, http_gateway_connection_port: int=19080, load_balance_ports=None, nat_ports=None, vm_password: str=None, fabric_settings=None, cluster_code_version: str=None, cluster_upgrade_mode=None, cluster_upgrade_description=None, reverse_proxy_endpoint_port: int=None, **kwargs) -> None:
        ...
        self.load_balance_ports = load_balance_ports
        self.nat_ports = nat_ports
        self.vm_admin_user = vm_admin_user
...
class ManagedClusterUpdateParameters(Model):
    ...
    def __init__(self, *, client_connection_port: int=None, http_gateway_connection_port: int=None, load_balance_ports=None, nat_ports=None, fabric_settings=None, cluster_code_version: str=None, cluster_upgrade_mode=None, cluster_upgrade_description=None, reverse_proxy_endpoint_port: int=None, tags=None, **kwargs) -> None:
...
class NatPort(Model):
    ...
    def __init__(self, *, frontend_start_port: int=None, backend_port: int=None, **kwargs) -> None:
        super(NatPort, self).__init__(**kwargs)
        self.frontend_start_port = frontend_start_port
        self.backend_port = backend_port
...
class NodeType(ProxyResource):
    ...
    :type ephemeral_ports:
     ~azure.mgmt.servicefabric.models.EndpointRangeDescription
    :param vm_sku: The size of virtual machines in the pool. All virtual
    ...
    _attribute_map = {
        ...
        'vm_sku': {'key': 'properties.vmSku', 'type': 'str'},
    ...
    def __init__(self, *, is_primary: bool, vm_instance_count: int, disk_size_in_gb: int, tags=None, placement_properties=None, capacities=None, application_ports=None, ephemeral_ports=None, vm_sku: str=None, vm_image_publisher: str=None, vm_image_offer: str=None, vm_image_sku: str=None, vm_image_version: str=None, vm_secrets=None, vm_extensions=None, **kwargs) -> None:
...
class VMSSExtension(Model):
    ...
    def __init__(self, *, name: str, publisher: str, type: str, type_handler_version: str, auto_upgrade_minor_version: bool=None, enable_automatic_upgrade: bool=None, settings=None, protected_settings=None, **kwargs) -> None:
