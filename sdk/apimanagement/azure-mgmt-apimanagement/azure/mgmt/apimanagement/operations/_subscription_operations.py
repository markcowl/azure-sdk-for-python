...
class SubscriptionOperations(object):
    ...
    def create_or_update(
            self, resource_group_name, service_name, sid, parameters, notify=None, app_type=None, if_match=None, custom_headers=None, raw=False, **operation_config):
        ...
        :type notify: bool
        :param app_type: The client application type notification links are
         pointing to.
        :type app_type: bool
        ...
        if app_type is not None:
            query_parameters['appType'] = self._serialize.query("app_type", app_type, 'bool')
        query_parameters['api-version'] = self._serialize.query("self.api_version", self.api_version, 'str')
    ...
    def update(
            self, resource_group_name, service_name, sid, parameters, if_match, notify=None, app_type=None, custom_headers=None, raw=False, **operation_config):
    ...
    def list_secrets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SubscriptionKeysContract or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.apimanagement.models.SubscriptionKeysContract or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.apimanagement.models.ErrorResponseException>`
        """
